...
df_mode = pd.read_csv("C:/Users/HajduPe/helmet-data-preprocessing/shares/shares_by_mode_3h-to-1h.csv", sep=";",decimal=",")
df_tr_class = pd.read_csv("C:/Users/HajduPe/helmet-data-preprocessing/shares/shares_by_transport_class_3h-to-1h.csv", sep=";",decimal=",")

print(df_mode.head())

print(volume_factors["car"]["aht"])
...
with open('C:/Users/HajduPe/H4_estimointi/Helmet4/helmet_estimation/skriptit/generated/assignment_dict.py', 'w') as f:
    for text in assignment_file:
        if type(text) == dict:
            f.write(print_dict(volume_factors, "volume_factors"))
        else:
            f.write(text)
